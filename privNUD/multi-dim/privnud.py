...
import dynamic_tree_def as Dyna
...
class PrivNud:       # 我
    ...
    def run_ldp(self, user_record):
        ...
        # user_record_1_way = user_record[0:point_d_Cd2]
        # user_record_2_way = user_record[point_d_Cd2:]
        user_record_1_way = user_record[0:int(self.args.user_num * self.args.alpha)]
        user_record_2_way = user_record[int(self.args.user_num * self.args.alpha):]
