...
class choose_granularity_beta:
    ...
    def get_1_way_granularity_for_HDG(self, ep = None):
        ...
        k = self.args.attr_num + self.args.attr_num * (self.args.attr_num - 1) // 2
    ...
    def get_2_way_granularity_for_HDG_2(self, ep = None):
        n = self.args.user_num
        # k = self.args.attr_num + self.args.attr_num * (self.args.attr_num - 1) // 2         # d + Cd2
        k = (self.args.attr_num * (self.args.attr_num - 1) // 2) / (1 - self.args.user_alpha)      # Cd2/(1-alpha)
    ...
    def get_2_way_granularity_for_TDG(self, ep=None):
        n = self.args.user_num
        k = self.args.attr_num * (self.args.attr_num - 1) // 2
