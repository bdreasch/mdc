...
def main_fun(repeat_time, domain_size, branch, ahead_tree_height, theta, real_frequency, query_interval_table, epsilon, data_name, data_size_name, domain_name, data_dimension, dataset, data_size):
    ...
    while repeat < repeat_time:
        ...
        ahead_tree_query_error_recorder(ahead_forest, ahead_tree_list, real_frequency, query_interval_table,
                                        domain_size, MSEDict, domain_combination_list, data_dimension)
...
if __name__ == "__main__":
    ...
    # running 
    main_fun(repeat_time, domain_size[:2], branch[:2], ahead_tree_height, theta, real_frequency,
             query_interval_table, epsilon, data_name, data_size_name, domain_name, data_dimension, dataset, data_size)
