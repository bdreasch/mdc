...
def ahead_tree_answer_query(ahead_tree, query_interval, domain_size):
    ...
    q_d1_left = int(query_interval[0])
    q_d1_right = int(query_interval[1])
    query_interval_temp[q_d1_left:q_d1_right] = 1
...
def main_func(repeat_time, domain_size, branch_factor, ahead_tree_height, theta, real_frequency,
    ...
    while repeat < repeat_time:
        ...
        ahead_tree_construction(ahead_tree, ahead_tree_height, theta, branch_factor,
                                translation_vector, user_dataset_partition)
...
if __name__ == "__main__":
    ...
    branch_factor = 2
    domain_size = 2 ** 10
    ahead_tree_height = int(math.log(domain_size, branch_factor))
    ...
    # running 
    main_func(repeat_time, domain_size, branch_factor, ahead_tree_height, theta, real_frequency, query_interval_table,
