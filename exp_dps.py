...
# USER_NUM = 694886
# DATASET = "bfive12b_dps"
# DATASET = "bfive12b_w4"
# DATASET = "bfive12b_exp_dps"
# DATASET = "bfive12_ndp"
...
# DATASET = "cov8_0"
# TXT_DATASET_PATH = "test_dataset/cov8_0.txt"
# DATASET = "cov8_01"
# TXT_DATASET_PATH = "test_dataset/cov8_01.txt"
# DATASET = "cov8_05"
# TXT_DATASET_PATH = "test_dataset/cov8_05.txt"
# DATASET = "cov8_09"
# TXT_DATASET_PATH = "test_dataset/cov8_09.txt"


#USER_NUM = 1000000
# DATASET = "cov24_3"
# TXT_DATASET_PATH = "test_dataset/cov24_3.txt"
# DATASET = "cov24_4"
# TXT_DATASET_PATH = "test_dataset/cov24_4.txt"
# DATASET = "cov24_5"
# TXT_DATASET_PATH = "test_dataset/cov24_5.txt"
#DATASET = "cov24_6"
#TXT_DATASET_PATH = "test_dataset/cov24_6.txt"
...
# USER_NUM = 694886 # for the old ones including 12 attrs
...
def sys_test(sr, algo, repeat, user_record, query_list,
             domains_list, attr_type_list):
    phi = 0.03
    progress = 0
    print("Executing {} {}".format(algo, sr))
    ...
    for r in range(0, repeat):
        ...
        it_data = [mae_error, sr, args.algorithm_name, all_end - allstart]
        ...
        print("progress {} {} : {}%".format(args.algorithm_name, sr, int((r+1)/repeat * 100)))
    ...
    print("algo: {} sr: {} done!".format(algo, sr))
...
if __name__ == '__main__':
    ...
    sr_l = [0.005, 0.01, 0.02]
    times_r = 10

    algo_l += [kPrivMDC] * len(sr_l)
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=5) as executor:
        future_to_config = {executor.submit(sys_test, sr, algo, times_r,
                                            u_ser_record, query_list,
                                            domain_list, attr_types_list):
                                [algo, sr] for algo, sr in zip(algo_l, sr_l)}
        for future in concurrent.futures.as_completed(future_to_config):
            ...
            try:
                ...
                print("e: {}".format(sr_l))
                print("maes:")
                for e, mae, std in zip(sr_l, maes, stds):
    ...
    plot.plot_std(sns_dataset=main_df, name="plot_eps_exp_ds{}_bn{}_ep{}_l{}_r{}".format(DATASET,
                                                                                         plot_args.bn_degree,
                                                                             plot_args.epsilon,
                                                                             plot_args.query_dimension, times_r))
    main_df.to_csv("e_exp_output/log_csv/log_" + DATASET + "_" + DATA_TYPE
                   + "_" + str(plot_args.dimension_query_volume) + "_" + "dps=all"
                   + ".csv", index=False)
